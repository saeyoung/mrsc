...
def experiment_2():
    ...
    for n in [2,3,5,8,13,21]:
        ...
        plt.savefig("result/boxplot/{}_states_markov_boxplot_semilog_{}_samples_long.png".format(n, samples))
        # plt.show()
        plt.clf()
        ...
        plt.xticks(np.arange(1,len(powers)+1),powers)
        plt.legend()
        plt.savefig("result/boxplot/{}_states_markov_boxplot_loglog_{}_samples_long.png".format(n, samples))
        # plt.show()
        plt.clf()
